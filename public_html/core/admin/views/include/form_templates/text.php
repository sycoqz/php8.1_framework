<div class="vg-element vg-full vg-box-shadow">
    <div class="vg-wrap vg-element vg-full vg-box-shadow">
        ...
        <div class="vg-element vg-full">
            <div class="vg-element vg-full vg-left ">
                <label>
                    <input type="text" name="<?=$row?>" class="vg-input vg-text vg-firm-color1" value="<?= isset($_SESSION['result'][$row])
                        ? htmlspecialchars($_SESSION['result'][$row]) : htmlspecialchars($this->data[$row])?>">
                </label>
            </div>
        </div>
    </div>
